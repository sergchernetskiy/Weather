...
export function createMarkup({ weather, main, wind, sys, name, clouds }) {
  ...
  return /*html*/ `<div class="weather__card">
      ...
      <ul class="weather-info list">
          ...
          <li class="weather-info-item">
              <p class="feels-like-temp">Опис: ${weather[0].description}</p>
          </li>
          <li class="weather-info-item">
              <p class="feels-like-temp">Швидкість вітру: ${wind.speed} м/с</p>
          </li>
          <li class="weather-info-item">
